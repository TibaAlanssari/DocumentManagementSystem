...
echo '<hr>';
echo '<button type="submit" name="submit" value="submit" class="btn btn-lg btn-block btn-secondary">Upload File</button>';
echo '</form>';
...
if (isset($_POST['submit']))
{
	...
	//fwrite($fp,$content);
	//fclose($fp);
	header("Location: https://192.168.56.101/upload.php?msg=success");
}
?>